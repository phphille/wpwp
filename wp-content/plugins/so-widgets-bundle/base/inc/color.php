 ...
 */
class SiteOrigin_Widgets_Color {
	/**
 ...
 */
class SiteOrigin_Widgets_Color_Object extends SiteOrigin_Widgets_Color{
	private $changed;
	 ...
	 */
	public static function distance(SiteOrigin_Widgets_Color_Object $c1, SiteOrigin_Widgets_Color_Object $c2){
		return sqrt(
