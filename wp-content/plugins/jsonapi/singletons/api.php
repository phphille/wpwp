...
class JSON_API {
  ...
  function admin_menu() {
    add_options_page('Bopoolen API Settings', 'API Settings', 'manage_options', 'json-api', array(&$this, 'admin_options'));
  }
...
<div class="wrap">
  ...
  <form action="options-general.php?page=json-api" method="post">
    ...
    <h3>Address</h3>
    <p>Specify a base URL for JSON API. For example, your API base URL would enable the following <code><?php bloginfo('url'); ?>/<?php echo get_option('json_api_base', 'api'); ?>/get_recent_posts/</code>.</p>
