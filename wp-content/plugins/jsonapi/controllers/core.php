...
class JSON_API_Core_Controller {
  ...
  protected function get_date_posts() {
    global $json_api;
  ...
  protected function get_date_index() {
    global $json_api;
  ...
  protected function get_category_index() {
    global $json_api;
    $args = null;
  ...
  protected function get_tag_index() {
    global $json_api;
  ...
  protected function get_author_index() {
    global $json_api;
